...
public abstract class Request<TRequest, TResult>
    ...
    where TResult : class
{
    public delegate void Delegate (TRequest request, Action<TResult> resultCallback, Action<PlayFabError> errorCallback, object customData = null, Dictionary<string, string> extraHeaders = null);
...
public class Inventory : Request<GetUserInventoryRequest, GetUserInventoryResult>
{
    public override Delegate Method => PlayFabClientAPI.GetUserInventory;

    public virtual void Send() => Send(new GetUserInventoryRequest() { });
}

public class PurchaseItem : Request<PurchaseItemRequest, PurchaseItemResult>
{
    public override Delegate Method => PlayFabClientAPI.PurchaseItem;
