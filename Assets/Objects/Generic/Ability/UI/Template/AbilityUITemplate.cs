...
namespace Game
{
    ...
    public class AbilityUITemplate : UIElement, IBeginDragHandler, IDragHandler, IEndDragHandler
    {
        [SerializeField]
        ...
        protected virtual void InventoryUpdateCallback() => UpdateState();
        ...
        public delegate void ClickDelegate(AbilityUITemplate template, AbilityTemplate data);
        ...
        #region Drag
        public delegate void DragDelegate(AbilityUITemplate template, AbilityTemplate data, PointerEventData pointerData);
