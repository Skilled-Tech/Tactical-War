...
Region.Progress=Progress;})(Region=PlayerData.Region||(PlayerData.Region={}));class Snapshot{constructor(data,region,occurrence){this.data=data;this.region=region;this.occurrence=occurrence;}
