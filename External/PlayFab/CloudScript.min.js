...
var rewards=template.items.slice();rewards.push(template.token);PlayFab.Catalog.Item.GrantAll(currentPlayerId,rewards,"New Player Welcome Reward");var result={items:rewards};return result;}
